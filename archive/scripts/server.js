...
// console.log("serverjs:"+response);
  connectdb.insertitems(req.query.id,req.query.name,req.query.description,req.query.container,req.query.unit,req.query.type,req.query.group,req.query.purchase,function(getcallback){
      if(getcallback=="saved!"){
        res.status(200).json({'returnval': "Saved!"});
